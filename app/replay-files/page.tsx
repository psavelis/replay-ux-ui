...
export default function App() {
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredReplayFiles = filteredReplayFiles.filter((replayFile) =>
  ...
  const renderCell = React.useCallback((replayFile, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "game_id":
        return (
          <div>
            ...
            <Avatar isBordered radius="sm" src="public/cs2logo.png" />
            {replayFile.game_id}
            <Spacer x={2} />
      ...
      case "status":
        return (
          <Chip className="capitalize" color={statusColorMap[replayFile.status]} size="sm" variant="flat">
            {cellValue}
          </Chip>
        );
      case "url":
        return (
          <div className="relative flex justify-end items-center gap-2">
            <Link href={replayFile.url}>{replayFile.network_id}</Link>
            <Spacer x={2} />
            <Dropdown>
              <DropdownTrigger>
